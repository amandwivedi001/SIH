...
<<<<<<< HEAD
  ...
  <div className="lg:w-1/2 flex flex-col text-center lg:text-left">
    ...
    {/* Heading Section (first on all screens) */}
    <div className="order-1">
      <h1 className="text-5xl sm:text-6xl font-extrabold leading-tight">
        Secure Real-Time{" "}
        <span className="text-blue-400">Device Tracking</span>
      </h1>
      <p className="text-lg text-slate-300 max-w-xl mx-auto lg:mx-0 mt-4">
        Monitor and track your valuable assets with enterprise-grade
        security, real-time location updates, and intelligent analytics.
      </p>
    </div>

    {/* Features Section (last on mobile, but stays under heading on desktop) */}
    <div className="order-3 lg:order-2 flex flex-col sm:flex-row sm:space-x-6 space-y-4 sm:space-y-0 mt-8 justify-center lg:justify-start">
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="flex flex-col-reverse lg:flex-row items-center lg:items-stretch gap-12">
        ...
        <div className="lg:w-1/2 space-y-8 text-center lg:text-left flex flex-col">
          ...
          {/* Login Form (shows between heading and features on mobile) */}
...
>>>>>>> b53938f5ddf880e341c31f13f9f29af1f4435c78
  );
};
